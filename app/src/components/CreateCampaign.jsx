  ...
  return (
    ...
    >
      <div className="bg-white p-4 rounded-lg max-w-xl w-full">
        {/* Heading */}
        <h2 className="text-center text-2xl font-semibold mb-4 border-b-2 border-blue-500 pb-2">
          Create New Campaign
        </h2>
        ...
        <div className="flex justify-end">
          {/* Cancel Button */}
          <button
            className="bg-gray-900 text-white rounded-lg px-4 py-2 mr-2"
            onClick={closeModal}
          >
            Cancel
          </button>
          {/* Create Button */}
          <button
  className="bg-blue-500 hover:bg-pink-600 text-white rounded-lg px-4 py-2"
  onClick={async () => {
