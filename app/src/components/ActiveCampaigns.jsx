...
export default function ActiveCampaigns({ contractAddress, abi }) {
  ...
  return (
    <>
      ...
      <div className="mt-20 md:text-left text-center">
        ...
        <h1 className="md:text-4xl md:font-semibold md:mx-20 text-xl md:p-0 py-5" style={{ background: '#003738', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
  Active Campaigns:
</h1>

          <button className="relative md:mx-20 rounded-xl border-4 overflow-hidden group p-2 text-blue-500 font-semibold hover:text-white">
  <div
    className="absolute w-full h-full left-0 top-0 transform translate-x-full group-hover:translate-x-0 transition-transform duration-500"
    style={{
      background: 'linear-gradient(90deg, #14C1EE, #16E9ED)',
    }}
  ></div>
  <div
    className="absolute w-full h-full left-0 top-0 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500"
  ...
  ></div>
  <div
    className="absolute w-full h-full left-0 top-0 transform -translate-y-full group-hover:translate-y-0 transition-transform duration-500"
    style={{
      background: 'linear-gradient(180deg, #14C1EE, #16E9ED)',
    }}
  ></div>
  <div
    className="absolute w-full h-full left-0 top-0 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500"
