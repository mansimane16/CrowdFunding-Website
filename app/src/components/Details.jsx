...
export default function Details() {
  ...
  return (
    <>
      <Toaster />
      <Navbar />
      <div class="my-10 text-3xl font-bold text-black ml-20 mb-12">
        Details Page
      </div>
      <div className="flex flex-wrap w-5/6  mx-auto p-0 md:pl-20">
        ...
        <div className="flex flex-col md:w-80 w-full justify-between text-center md:text-left text-black mt-10 md:m-0">
          <div >
      ...
      <div className="my-14 flex md:justify-end justify-center md:w-4/5 w-full">
        {address == owner && (
          <button
            className="bg-white text-blue-600 hover:bg-blue-500 hover:text-white  p-3 mx-5 rounded-lg font-semibold"
            onClick={async () => {
              if (raised < target) {
        ...
        <button
          className="bg-blue-300 text-black p-3 rounded-lg font-semibold hover:bg-skyblue-900 hover:text-white"
      ...
      {contribution.length == 0 && (
        <div className="my-10 text-center text-3xl font-bold flex justify-center" style={{ background: 'linear-gradient(90deg, #14C1EE, #16E9ED)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
