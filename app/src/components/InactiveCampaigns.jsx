...
export default function InactiveCampaigns({ contractAddress, abi }) {
  ...
  return (
    <div>
    <h1 className="md:text-4xl md:font-semibold md:mx-20 text-xl md:p-0 py-5 mt-20 md:text-left text-center" style={{ background: '#003738', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
  Past Campaigns:
</h1>
